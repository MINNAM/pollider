        ...
        return (
            ...
            <div
                ...
                style     = {{
                    borderTop    : "",
                    position     : 'relative',
                    borderBottom : this.props.last ? '1px solid rgb(240,240,240)' : '',
                    marginBottom : this.state._row ? ( this.state._row.parentNode.className == 'parent-row' ?  0 : 0 ) : 0,
                    padding       : 0
                }}
            >
                ...
                <div
                    style = {{
                        ...
                        height         : 25,
                        width          : '100%',
                        background     : this.state._row ? this.state._row.parentNode.className == 'parent-row' ?  'rgb(220,220,220)' : 'rgb(240,240,240)' : '',
                        backgroundSize : "100% 30px",
                        position       : 'relative',
                        boxSizing      : 'border-box',
                        borderTop      : this.props.last ? '1px solid rgb(220,220,220)' : '',
                        marginTop      : 0
                    }}
                >
                    ...
                    <IconMenu
                        style              = {{ float : 'right' }}
                        iconButtonElement  = { <IconButton style = {{ marginTop: -12, marginRight: 5.5 }} iconStyle = {{ height : 22, width : 22, color : this.state._row ? this.state._row.parentNode.className == 'parent-row' ?  'rgb(160,160,160)' : 'rgb(100,100,100)' : ''}}><MoreHorizIcon /></IconButton> }
